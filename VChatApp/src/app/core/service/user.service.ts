...
export class UserService {
  ...
  approve(contactCode: string) {
    return this.http.get(AppRoutingApi.Approve + "/" + contactCode);
  }

  reject(contactCode: string) {
    return this.http.get(AppRoutingApi.Reject + "/" + contactCode);
  }
}

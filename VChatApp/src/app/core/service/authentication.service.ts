...
export class AuthenticationService {
    ...
    confirm(userCode: string, tokenCode: string, otpCode: string) {
        return this.http.post(AppRoutingApi.Confirm + `?userCode=${userCode}&tokenCode=${tokenCode}&otpCode=${otpCode}`, null);
    }
}

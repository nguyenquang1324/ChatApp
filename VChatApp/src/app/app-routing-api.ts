...
export class AppRoutingApi {
    ...
    static Confirm = environment.apiUrl + "auths/confirm";
    ...
    static DeleteAllMessage = environment.apiUrl + "chatBoards/delete-all-message";
    static LeaveGroup = environment.apiUrl + "chatBoards/leave-group";
    ...
    static Approve = environment.apiUrl + "users/approve";
    static Reject = environment.apiUrl + "users/reject";
}
